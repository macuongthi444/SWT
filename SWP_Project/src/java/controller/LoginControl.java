    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acc == null) {
            ...
            if (acc.getRole().getRoleName().equalsIgnoreCase("Admin")) {
                response.sendRedirect("/SWP_Project/adminView/Dashboards.jsp");
                session.setAttribute("accl", acc);

            } else if (acc.getRole().getRoleName().equalsIgnoreCase("Guest")) {
                response.sendRedirect("/SWP_Project/adminView/Home.jsp");
