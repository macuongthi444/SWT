            ...
            google.chart.load('current',{'packages':['corechart']});
                        ...
                        function drawChart(result) {
                            ...
                            data.addColumn('number', 'Quantity');
                                <c:forEach item="${po}" var="po">
                           var name="${po.productid.categoryid.categoryName}"
                           var total = ${item.numberrom}
                            ...
                            <ul class="menu-sub">
                                ...
                                <li class="menu-item active">
                                    <a href="/SWP_Project/UserList" class="menu-link">
                                        <div data-i18n="UserList">User</div>
                                    </a>
                                </li>
                                ...
                                <div class="col-lg-8 mb-4 order-0">
                                    <div class="card">
                                        <div class="d-flex align-items-end row">
                                            <div class="col-sm-7">
                                                <div class="card-body">
                                                    <div id="barchart" width="400" height="400"></div>
